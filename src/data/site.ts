...
export const REGISTER_URL = 'https://tally.so/r/A7Y8Zl';
export const APPLICATION_URL = 'https://tally.so/r/A7Y8Zl';
export const SPONSOR_URL = 'https://unfold-sponsorship-deck.netlify.app/';
